      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.2, duration: 0.6 }}
            className="rounded-3xl overflow-hidden shadow-soft-lg border-8 border-white"
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3443.4!2d78.0!3d30.3!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzDCsDE4JzAwLjAiTiA3OMKwMDAnMDAuMCJF!5e0!3m2!1sen!2sin!4v1234567890"
              width="100%"
              height="500"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Arambhik Academy Location"
            ></iframe>
          </motion.div>
        </div>
      </section>
