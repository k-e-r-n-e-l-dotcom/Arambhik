...
import { BookOpen, Users, Award, TrendingUp, ChevronDown, Quote, ArrowRight, Star } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="backdrop-blur-md bg-white/10 border border-white/20 p-10 rounded-3xl hover:-translate-y-2 hover:shadow-colored-amber transition-all duration-500"
              >
                <div className="text-6xl font-bold mb-3 bg-gradient-to-br from-white to-accent-400 bg-clip-text text-transparent">
                  {stat.value}
                </div>
                <div className="text-lg text-slate-200 font-semibold">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
