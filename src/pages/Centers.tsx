          ...
          >
            ...
            <div className="p-10 space-y-8">
              ...
              >
                ...
                <div>
                  <h3 className="font-bold text-primary-900 mb-2 text-lg">Address</h3>
                  <a
              ...
              >
                ...
                <div>
                  <h3 className="font-bold text-primary-900 mb-2 text-lg">Phone</h3>
            ...
            <div className="p-10 bg-gradient-to-br from-primary-900 to-primary-800 text-white">
              <div className="text-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 px-8 py-4 bg-accent-500 text-white rounded-full hover:shadow-glow hover:-translate-y-1 hover:bg-accent-600 transition-all font-semibold"
                >
