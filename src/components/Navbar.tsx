        ...
        <div className="px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center space-x-2 group">
              ...
              <span className="text-lg font-bold font-montserrat text-primary-900">Arambhik Academy</span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8">
              {!profile ? (
                <>
                  {publicLinks.map(link => (
                    <Link
                      key={link.to}
                      to={link.to}
                      className="text-sm font-semibold text-slate-600 hover:text-primary-900 transition-colors relative group"
                    >
                      {link.label}
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 bg-slate-900 text-white px-6 py-2.5 rounded-full font-semibold shadow-lg shadow-blue-900/20 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-900/30 transition-all duration-300 border border-white/10"
                  >
                  ...
                  <Link
                    to="/login?role=admin"
                    className="flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-6 py-2.5 rounded-full font-semibold shadow-lg shadow-orange-500/30 hover:-translate-y-1 hover:shadow-xl hover:shadow-orange-500/40 transition-all duration-300"
                  >
                ...
                <>
                  <span className="text-sm text-slate-600 font-medium">Welcome, {profile.full_name}</span>
                  <Link
                    to={dashboardPath}
                    className="flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg font-bold shadow-lg hover:bg-blue-700 hover:-translate-y-0.5 transition-all duration-200"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-red-50 text-red-700 rounded-xl hover:bg-red-100 transition-all font-medium text-sm"
                  >
